...
/*!
 * Radio receiver modes
 */

#define RX_SINGLE_MODE 0x0
 ...
 *
 * \param   rxPeriod        Structure describing reception timeout value
 * \param   sleepPeriod     Structure describing sleep timeout value
 */
